...
<div class="row">
    <div class="col-md-6">
        ...
        <input type="datetime-local" class="form-control" name="date_start" id="date-start"
            value="{{old('date_start', $disCount->date_start)}}">
    ...
    <div class="col-md-6">
        ...
        <input type="datetime-local" class="form-control" name="date_end" id="date-end"
            value="{{old('date_end', $disCount->date_end)}}">
...
<label for="product" class="form-label">Chi tiết sản phẩm:</label> <input type="checkbox" id="checkbox-all"
    hidden /><label hidden>Chọn tất cả</label>
