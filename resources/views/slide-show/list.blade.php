...
<div class="md fade" id="exampleModal" tabindex="-1" aria-labelledby="examplemdLabel" aria-hidden="true">
    <div class="md-dialog">
        <div class="md-content">
            ...
            <form method="POST" action="{{ route('logo.update', ['id' => $loGo->id]) }}" id="importForm"
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a id="showModalButton" class="btn btn-outline-primary" title="Cập nhật"><i
            ...
            <tbody>
                @foreach($listSlide as $slide)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('slide-show.update', ['id' => $slide->id]) }}" title="Cập nhật"
                                class="btn btn-outline-primary"><i class="fas fa-edit"></i></a> |
                            <a href="{{ route('slide-show.delete', ['id' => $slide->id]) }}" title="Xóa"
